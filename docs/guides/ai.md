...
bills on. The tile shows the two apart, because output costs several times more than input. With Claude nothing is cached, so it is every token sent and received. OpenAI and Gemini
